...
export default function Projects({ onOpenPlaceholder }) {
  return (
    <section id="projects" className="py-24 bg-[#080808] border-t border-white/10 relative">
        ...
        <div className="space-y-16">
          {projectsData.map((project, idx) => {
            ...
            return (
              <div 
                key={project.id}
                className="rounded-2xl bg-[#0D0D0D] border border-white/10 overflow-hidden transition-all duration-200 hover:border-white/25 shadow-2xl"
              >
                <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 p-6 sm:p-10 items-center`}>
                  ...
                  <div className={`space-y-6 ${isEven ? 'lg:col-span-6 lg:order-2' : 'lg:col-span-6 lg:order-1'}`}>
                    ...
                    {/* Why I Built It */}
                    <div className="rounded-xl bg-black border border-white/10 p-4 space-y-1.5">
                    ...
                    {project.whatILearned && (
                      <div className="rounded-xl bg-black/60 border border-white/10 p-4 space-y-1.5">
                    ...
                    {/* Tech Stack Pills with crisp white borders */}
                    ...
                    <div className="flex flex-wrap items-center gap-3 pt-2">
                      {project.liveUrl ? (
                        <a
                          ...
                          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#00D6A3] text-black font-sans text-xs font-semibold shadow-[0_0_20px_rgba(0,214,163,0.3)] hover:shadow-[0_0_28px_rgba(0,214,163,0.45)] transition-all active:scale-95"
                        >
                          <span>Live Demo</span>
                      ...
                      {project.githubUrl ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#141414] text-white border border-white/15 hover:border-white/30 text-xs font-sans font-medium transition-all"
                        >
                  ...
                  {/* Visual Showcase Card with Crisp White Border */}
                  <div className={`${isEven ? 'lg:col-span-6 lg:order-1' : 'lg:col-span-6 lg:order-2'}`}>
                    <div 
                      ...
                      className="group/mockup relative rounded-xl bg-black border border-white/15 p-5 sm:p-7 min-h-[290px] flex flex-col justify-between cursor-pointer hover:border-white/30 transition-all duration-200 overflow-hidden shadow-xl"
                    >
                      {/* Window Header */}
